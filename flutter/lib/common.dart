...
class MyTheme {
  ...
  // TacholilRemote: acento = verde de marca TGD-Pro (#2ECC71), en vez del azul RustDesk (#0071FF)
  ...
  static const Color button = Color(0xFF27AE60); // TacholilRemote: verde botón TGD-Pro (#27AE60)
